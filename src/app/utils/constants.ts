...
export class Constants {
  ...
  static readonly IMG_LIST: MyImage[] = [
    ...
    new MyImage('large-boot.jpg', 'Boot (large)'),
    new MyImage('subwoofer.jpg', 'Subwoofer'),
    new MyImage('amplifiers.jpg', 'Amplifiers'),
    new MyImage('DSC_0927.jpg', 'Inside, front'),
    new MyImage('dash.jpg', 'Dash'),
    new MyImage('console.jpg', 'Console'),
